...
from workflow_agents import DirectPromptAgent # TODO: 1 - Import the DirectPromptAgent class from BaseAgents
import os
...
direct_prompt_agent = DirectPromptAgent(openai_api_key, base_url)
...
print("This agent used general knowledge from the LLM")
