...
knowledge_augmented_prompt_agent = KnowledgeAugmentedPromptAgent(openai_api_key, base_url, persona, knowledge)
...
knowledge_augmented_prompt_response = knowledge_augmented_prompt_agent.respond(prompt)

print(knowledge_augmented_prompt_response)
